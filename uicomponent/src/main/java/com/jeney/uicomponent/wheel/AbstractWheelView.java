...
package com.jeney.uicomponent.wheel;
...
public abstract class AbstractWheelView extends AbstractWheel {
    ...
    protected void initAttributes(AttributeSet attrs, int defStyle) {
        ...
        mSelectionDividerActiveAlpha = a.getInt(R.styleable.AbstractWheelView_wheelSelectionDividerActiveAlpha, DEF_SELECTION_DIVIDER_ACTIVE_ALPHA);
        mSelectionDividerDimmedAlpha = a.getInt(R.styleable.AbstractWheelView_wheelSelectionDividerDimmedAlpha, DEF_SELECTION_DIVIDER_DIMMED_ALPHA);
        ...
        mSelectionDivider = a.getDrawable(R.styleable.AbstractWheelView_wheelSelectionDivider);
        a.recycle();
    }
