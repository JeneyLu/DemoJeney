...
package com.jeney.demojeney.FlippableStackView;
 ...
 * 12.12.14
 */
public class FlippableStackViewActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_flippable_stackview);
